...
Original file is located at
    https://colab.research.google.com/drive/1VllK3TkcdOjImQv17pR0tB7TX_EeoaZW
...
zebra_imgs = load_image_tensors('zebra', root_path='data', transform=False)
...
axs[0].imshow(zebra_imgs[30])
axs[1].imshow(zebra_imgs[31])
axs[2].imshow(zebra_imgs[24])
axs[3].imshow(zebra_imgs[21])
axs[4].imshow(zebra_imgs[20])
