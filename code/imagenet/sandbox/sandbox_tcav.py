...
time_pre_tcav_interp = time.time()
print("Time to begin doing anything: {}".format(time_pre_tcav_interp-time_start))
...
time_pre_tcav_comp = time.time()
print("Time to tcav.interpret: {}".format(time_pre_tcav_comp-time_pre_tcav_interp))
...
print("Time to tcav_comparison: {}".format(time.time()-time_pre_tcav_comp))
...
print("Time to pval: {:.2f}".format(time.time()-time_pre_pval))
print("scores")
print(scores)
